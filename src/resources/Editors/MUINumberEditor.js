...
class MUINumberEditor extends React.Component {
    ...
    render(): ?ReactElement {
        return (<MUINumberEditorRaw height={this.props.height} onKeyDown={this.props.onKeyDown} value={this.state.value}
...
export default (MUINumberEditor);
