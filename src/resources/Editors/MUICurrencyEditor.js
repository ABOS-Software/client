...
class MUICurrencyEditor extends React.Component {
    ...
    render(): ?ReactElement {
        return (
            <MUICurrencyEditorRaw height={this.props.height} onKeyDown={this.props.onKeyDown} value={this.state.value}
                                  onChange={this.handleChange}>

            </MUICurrencyEditorRaw>);
    }

}

export default (MUICurrencyEditor);
